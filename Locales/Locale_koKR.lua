...
L.OPT_RAID_SOUND        = "공격대에서 신규 플레이어 합류 알림음 켜기"
L.OPT_APPLICANT_ALERT_ALL = "파티원일 때도 신규 지원자가 발생하면 알림음 받기"
L.OPT_APPLICANT_NO_RAID = "공격대에서는 신규 지원자 알림 받지 않기"
...
L.SOUND_GUIDE_HEADER    = "[ 사용자 지정 사운드 파일 적용 방법 ]"
L.SOUND_GUIDE1          = "드롭다운에서 '사용자 설정' 선택 후, Interface 폴더 하위 경로에 사운드 파일(mp3, ogg, wav)을 넣어 적용할 수 있습니다."
L.SOUND_GUIDE2          = "경로 예시) Interface\\AddOns\\SolaQoL\\Media\\YourSound.mp3"
L.SOUND_WARNING         = "※ 새 사운드 파일을 폴더에 추가한 경우, 게임 클라이언트를 완전히 종료 후 재실행해야 인식됩니다."
