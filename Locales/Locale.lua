...
L.OPT_RAID_SOUND        = "Enable new player join sound alert in raid"
L.OPT_APPLICANT_ALERT_ALL = "Receive sound alerts for new applicants even as a party member"
L.OPT_APPLICANT_NO_RAID = "Do not receive applicant alerts in raid"
...
L.SOUND_GUIDE_HEADER    = "[ Custom Sound File Setup Guide ]"
L.SOUND_GUIDE1          = "Select 'Custom Path' from the dropdown and place your sound file (mp3, ogg, wav) inside the Interface folder."
L.SOUND_GUIDE2          = "Example path) Interface\\AddOns\\SolaQoL\\Media\\YourSound.mp3"
L.SOUND_WARNING         = "* If you added new sound files to the folder, you must fully restart the WoW game client to take effect."
